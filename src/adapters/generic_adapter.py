...
class GenericWorkflowAdapter(AbstractWorkflowAdapter):
    ...
    def create_workflow_config(self):
        ...
        """
        self.workflow_config['workflow_type'] = 'linear'
        ...
        edges = [
            {
                ...
                "next_node": nodes_ordered[i + 1]["blockType"]
            }
            for i in range(len(nodes_ordered) - 1)
        ]
        self.workflow_config['edges'] = edges
